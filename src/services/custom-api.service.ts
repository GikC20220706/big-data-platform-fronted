...
export const UpdateCustomApiData = (params: any) => customApiService.updateCustomApiData(params.id, params)
export const DeleteCustomApiData = (params: any) => customApiService.deleteCustomApiData(params.id)
